...
import com.fpts.api.enums.SpecResponseFields;
...
public class TestSpecification {
     ...
     *
     * @param spec        The specification to be append
     * @param httpMethod  Http method for the new specification
     * @param description Description for the new specification
     * @param parameter   The request parameter for the new specification
     * @param validation  The validation data for the new specification
     * @param jsonSchema  The JSON Schema for the paramater
